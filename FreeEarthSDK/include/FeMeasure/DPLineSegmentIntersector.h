...
namespace FeMeasure 
{
     ...
     */
    class FEMEASURE_EXPORT CDPLineSegmentIntersector : public osgUtil::LineSegmentIntersector
    {
    public:
        CDPLineSegmentIntersector(const osgUtil::Intersector::CoordinateFrame& cf, const osg::Vec3d& start, const osg::Vec3d& end)
            : osgUtil::LineSegmentIntersector(cf, start, end) { }

        CDPLineSegmentIntersector(const osg::Vec3d& start, const osg::Vec3d& end)
            : osgUtil::LineSegmentIntersector(start, end) { }

        /** dtor */
        virtual ~CDPLineSegmentIntersector() { }
