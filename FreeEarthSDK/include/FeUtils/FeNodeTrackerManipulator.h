...
#ifndef FE_NODE_TRACKER_MANIPULATOR
#define FE_NODE_TRACKER_MANIPULATOR
...
namespace FeUtil
{
	class FEUTIL_EXPORT CNodeTrackerManipulator : public osgGA::NodeTrackerManipulator,public FeUtil::FreeEarthManipulatorBase
	{
	public:
...
#endif // FE_NODE_TRACKER_MANIPULATOR
