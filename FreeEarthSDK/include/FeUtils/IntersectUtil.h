...
namespace FeMath
{
	extern FEUTIL_EXPORT bool intersectWithEllipse(double aAxis,double bAxis,double cAxis,osg::Vec3d& p1,osg::Vec3d& p2,osg::Vec3d& out_pt1,osg::Vec3d& out_pt2);

	extern FEUTIL_EXPORT int getLinePanelIntersec(osg::Vec3d linePoint, osg::Vec3d lineVector,osg::Vec3d planePoint,osg::Vec3d planeNor, double& tHit,osg::Vec3d& PHit);

	class FEUTIL_EXPORT aabbox3d
	{
	public:
...
#define	F32_LOWER_EQUAL_0(n)	((n) <= 0.0f)
	...
	class FEUTIL_EXPORT triangle3d
	{
	public:
		triangle3d();
		~triangle3d();
	...
	class FEUTIL_EXPORT COctreeTriangleSelector 
	{
	public:

		struct FEUTIL_EXPORT SOctreeNode
		{
			SOctreeNode()
			{
				for (int i=0; i!=8; ++i)
		...
		struct FEUTIL_EXPORT MyTriangleFunctor
		{
			MyTriangleFunctor()
			{
			}
		...
		struct FEUTIL_EXPORT ModelTriangleFunctor
		{
		...
		template<class T>
		class FEUTIL_EXPORT DoubleTriangleFunctor : public osg::TriangleFunctor<T>
		{
		...
		class FEUTIL_EXPORT MyGeometryVisitor : public osg::NodeVisitor
		{
		public:
		...
		//void ConstructTriangleOctree(const osg::Group & triangleNode);
		void ConstructTriangleOctree(osg::Drawable* pDrawable);
		bool ConstructTriangleOctree(osg::Node* n,osg::Matrix sm,int minimalPolysPerNode = 100);
		void ConstructTriangleOctree(osg::Group & triangleNode,int minimalPolysPerNode = 100);
	...
	class FEUTIL_EXPORT CSceneCollisionManager
	{
	public:
