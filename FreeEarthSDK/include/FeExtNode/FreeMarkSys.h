...
namespace FeExtNode
{
	...
	/**
	  ...
	  * @author c00005
	*/
    class FEEXTNODE_EXPORT CFreeMarkSys : public FeUtil::CSceneSysCall
    {
    public:
		/**  
		  * @note 场景标记系统的构造函数
	...
	public:
		/**  
		  ...
		  * @return bool 添加是否成功
		*/
		bool AddMark(CExternNode* pMark);
		...
		/**  
		  ...
		  * @return bool 添加是否成功
		*/
		bool AddMark(CExComposeNode* pParent, CExternNode* pMark);
		...
		/**  
		  ...
		  * @return bool 移除是否成功
		*/
		bool RemoveMark(CExternNode* pMark);
		...
		/**  
		  ...
		  * @return bool 移除是否成功
		*/
		bool RemoveMark(CExComposeNode* pParent, CExternNode* pMark);
		...
		*/
		CExternNode* GetMark(const FEID& nId);

		/**  
		  * @note 获取场景标记的根节点  
		*/
		CExComposeNode* GetRootMark();


	private: // 标牌对外的操作使用统一接口 AddMark , RemoveMark
		...
		/**  
		  ...
		  * @return 是否添加成功
		*/
		bool AddLabelHandler(CExLabelNode* pLabelNode);
		...
		/**  
		  ...
		  * @return 是否移除成功
		*/
		bool RemoveLabelHandler(CExLabelNode* pLabelNode);
	...
	public:   
		...
		*/
		...
		/**
		  * @note 开始编辑标记节点
		*/
		bool StartEdit(CExternNode* pMark);

		/**
		  * @note 结束编辑标记节点
		*/
		bool StopEdit(CExternNode* pMark);

		/**
		  * @note 获取事件监听管理器
		*/
		CFeEventListenMgr* GetEventListenManager();
	...
	protected:
		...
		osg::ref_ptr<CExComposeNode>				m_rpMarkRoot;

		osg::ref_ptr<CSceneMarkHandler>				m_rpSceneMarkHandler;

		/// 标牌节点拣选事件回调
		osg::ref_ptr<CExLabelCullEventHandler>      m_rpLabelCullEventHandler;
		
		/// 标牌事件处理
		osg::ref_ptr<CExLabelMouseEventHandler>		m_rpLabelEventHandler;

		/// 事件监听管理
		osg::ref_ptr<CFeEventListenMgr>             m_rpEventListenMgr;
