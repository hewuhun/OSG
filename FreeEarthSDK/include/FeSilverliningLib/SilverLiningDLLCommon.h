...
SILVERLININGDLL_API void *           SetEnvironment(bool rightHanded, void *env, SilverLining::ResourceLoader *resourceLoader, SilverLining::Allocator *allocator,
    const char* userDefinedVertString, const char* userDefinedFragString );
typedef void *                       (*SET_ENV_PROC)(bool, void *, SilverLining::ResourceLoader *, SilverLining::Allocator *, const char*, const char* );
...
typedef bool (*SET_DEPTH_RANGE_PROC)(float, float );
...
SILVERLININGDLL_API void             DeleteShader(SilverLining::ShaderHandle shader);
typedef void (*DELETE_SHADER_PROC)(SilverLining::ShaderHandle);
...
// Set whether 2D texture mapping is enabled.
SILVERLININGDLL_API bool             EnableTexture3D(bool);
typedef bool (*ENABLE_TEXTURE_3D_PROC)(bool);
...
SILVERLININGDLL_API bool             BackfaceCullClockwise(bool);
typedef bool(*BACKFACE_CULL_CLOCKWISE_PROC)(bool);
...
SILVERLININGDLL_API bool             Load3DTexture(unsigned char *data, int width, int height, int depth, SilverLining::TextureHandle *texHandle, bool, bool, bool);
typedef bool (*LOAD_3D_TEXTURE_PROC)(unsigned char *, int, int, int, SilverLining::TextureHandle *, bool, bool, bool);

// Load a 3D texture from the bytes passed in explicitly (24 bits per texel).
SILVERLININGDLL_API bool             Load3DTextureRGB(unsigned char *data, int width, int height, int depth, SilverLining::TextureHandle *texHandle, bool, bool, bool);
typedef bool (*LOAD_3D_TEXTURE_RGB_PROC)(unsigned char *, int, int, int, SilverLining::TextureHandle *, bool, bool, bool);

// Load a 3D texture from the bytes passed in explicitly (16 bits per texel).
SILVERLININGDLL_API bool             Load3DTextureLA(unsigned char *data, int width, int height, int depth, SilverLining::TextureHandle *texHandle, bool, bool, bool);
typedef bool (*LOAD_3D_TEXTURE_LA_PROC)(unsigned char *, int, int, int, SilverLining::TextureHandle *, bool, bool, bool);

// Update a 3D texture block from the bytes passed in explicitly (16 bits per texel).
SILVERLININGDLL_API bool             SubLoad3DTextureLA( unsigned char * data, int width, int height, int depth, int x, int y, int z, int dataRowPitch, int dataSlicePitch, SilverLining::TextureHandle texHandle );
typedef bool (*SUBLOAD_3D_TEXTURE_LA_PROC)( unsigned char *, int, int, int, int, int, int, int, int, SilverLining::TextureHandle );
...
SILVERLININGDLL_API bool             Enable3DTexture(SilverLining::TextureHandle texture, int stage);
typedef bool (*ENABLE_3D_TEXTURE_PROC)(SilverLining::TextureHandle, int);
...
SILVERLININGDLL_API bool             MakeRenderTextureCurrent(SilverLining::RenderTextureHandle texHandle, bool clear);
typedef bool (*MAKE_RENDER_TEXTURE_CURRENT_PROC)(SilverLining::RenderTextureHandle, bool);
...
typedef bool (*INIT_RENDER_TEXTURE_CUBE_PROC)(int, int, SilverLining::RenderTextureHandle *, bool);
...
typedef bool (*MAKE_RENDER_TEXTURE_CUBE_CURRENT_PROC)(SilverLining::RenderTextureHandle, bool, CubeFace);
...
typedef bool (*GET_RENDER_TEXTURE_CUBE_TEXTURE_HANDLE_PROC)(SilverLining::RenderTextureHandle, SilverLining::TextureHandle *);

SILVERLININGDLL_API bool             BindRenderTextureCube(SilverLining::RenderTextureHandle texHandle);
typedef bool (*BIND_RENDER_TEXTURE_CUBE_PROC)(SilverLining::RenderTextureHandle);

SILVERLININGDLL_API bool             ReleaseRenderTextureCube(SilverLining::RenderTextureHandle texHandle);
typedef bool (*RELEASE_RENDER_TEXTURE_CUBE_PROC)(SilverLining::RenderTextureHandle);
...
typedef bool (*GET_PIXELS_PROC)(int, int, int, int, void *, bool);
...
SILVERLININGDLL_API bool             DrawAALines(const SilverLining::Color& c, double width, const SL_VECTOR(SilverLining::Vector3)& points);
typedef bool (*DRAW_AA_LINES_PROC)(const SilverLining::Color& c, double width, const SL_VECTOR(SilverLining::Vector3)&);
...
SILVERLININGDLL_API void             SetUserShaders(const SL_VECTOR(unsigned int)& shaderObjects);
typedef void (*SET_USER_SHADERS_PROC)(const SL_VECTOR(unsigned int)&);
