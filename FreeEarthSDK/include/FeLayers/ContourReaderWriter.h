#ifndef FE_LAYERS_CONTOUR_READER_WRITER_H
#define FE_LAYERS_CONTOUR_READER_WRITER_H
...
namespace FeLayers
{
    ...
    * @author c00005
    */
    class FELAYERS_EXPORT CContourConfig
	{
	public:
...
namespace FeLayers
{
    /**
      ...
      * @author c00005
    */
	class FELAYERS_EXPORT CContourCfgReaderWriter :public FeUtil::TiXmlVisitor
	{
	public:
	...
	/**
      ...
      * @author c00005
    */
	class FELAYERS_EXPORT CContourReaderWriter : public FeUtil::TiXmlVisitor
	{
	public:
