...
#include <FeKits/IR/SulScreenAlignedQuad.h>
...
namespace FeKit
{
	...
	CSulScreenAlignedQuad::CSulScreenAlignedQuad( float fViewW, float fViewH, const std::string& fileTexture )
	{
		setName( "CSulScreenAlignedQuad" );
	...
	void CSulScreenAlignedQuad::setTexture( osg::Texture* pTex, sigma::uint32 unit, const std::string& uniformName )
	{
