...
void CumulusCongestusCloud::InitializeVoxelState()
{
    int i, j, k;
...
void CumulusCongestusCloud::ApplyWindShear(const Vector3& wind)
{
...
void CumulusCongestusCloud::IncrementTimeStep(unsigned long now)
{
    fadeStartTime = now;
