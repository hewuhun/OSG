...
* @data 2017-1-19
**************************************************************************************************/
#ifndef VECTOR_LAYER_DIALOG_H
#define VECTOR_LAYER_DIALOG_H
...
#include "ui_VectorLayerDialog.h"
...
namespace FreeViewer
{
	/**
	  ...
	  * @author w00040
	*/
	class CVectorLayerDialog : public CFreeDialog
	{
	...
	public:
		/**  
		  * @brief 构造函数
		*/
		CVectorLayerDialog(QWidget *parent, FeLayers::CLayerSys * pCustomLayerSys);
	...
	private:
		Ui::CVectorLayerDialog ui;
		QWidget *                   m_pTab_font;
		QWidget *                   m_pTab_style;
