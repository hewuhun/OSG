	...
	:_enableReflection(true)
{
	...
	_shadowMapWorldViewProjMatUniform = new Uniform(Uniform::FLOAT_MAT4,"osg_ShadowMapWorldViewProjMat",3);
	getOrCreateStateSet()->addUniform(_shadowMapWorldViewProjMatUniform);
}
...
Drawable::Drawable(const Drawable& drawable,const CopyOp& copyop):
	...
	_enableReflection(drawable._enableReflection),
	_shadowMapWorldViewProjMatUniform(drawable._shadowMapWorldViewProjMatUniform)
//	_enableReflection(true)
{
