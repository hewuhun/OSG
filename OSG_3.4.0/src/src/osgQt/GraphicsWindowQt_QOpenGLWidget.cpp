...
GLWidget::GLWidget( QWidget* parent, const QOpenGLWidget* shareWidget, Qt::WindowFlags f, bool forwardKeyEvents )
...
GLWidget::GLWidget( QOpenGLContext* context, QWidget* parent, const QOpenGLWidget* shareWidget, Qt::WindowFlags f,
...
GLWidget::GLWidget( const QGLFormat& format, QWidget* parent, const QOpenGLWidget* shareWidget, Qt::WindowFlags f,
                    bool forwardKeyEvents )
: QOpenGLWidget(parent, f),
_gw( NULL ),
_touchEventsEnabled( false ),
...
bool GraphicsWindowQt::realizeImplementation()
{
    ...
    {
        if ( savedContext )
            const_cast< QOpenGLContext* >( savedContext )->makeCurrent(_widget->context()->surface());
...
{
    _widget->context()->swapBuffers(_widget->context()->surface());
